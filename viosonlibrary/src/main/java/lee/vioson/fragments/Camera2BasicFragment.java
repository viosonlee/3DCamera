...
import lee.vioson.widget.AutoFitTextureView;

/**
 * Author:李烽
 * Date:2016-06-23
 * FIXME
 * Todo camera2包下面的拍照实现
 */
@TargetApi(Build.VERSION_CODES.LOLLIPOP)
public abstract class Camera2BasicFragment extends Fragment implements
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(getTextureViewLayoutId(), container, false);
    }
     ...
     * @return
     */
    protected abstract int getTextureViewLayoutId();

    /**
     * AutoFitTextureView 的id
     *
     * @return
     */
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        mTextureView = (AutoFitTextureView) view.findViewById(getTextureViewId());
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        mFile = new File(setFilePath());
    }
    ...
    protected void takePicture(File fileDir, String fileName) {
...
//                    showToast("Saved:" + mFile);
                    ...
                    unlockFocus();
                    mSaveHandler.sendEmptyMessage(SAVE_IMAGE_OK);
                }
            };
    ...
    private static final int SAVE_IMAGE_OK = 0x005;
    private SaveHandler mSaveHandler = new SaveHandler();
...
//        Camera2BasicFragment.listener = listener;
//    }
//
//    private static SaveImageListener listener;
//
